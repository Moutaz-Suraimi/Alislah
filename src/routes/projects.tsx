    ...
    <Layout>
      ...
      <section className="relative flex min-h-[35vh] flex-col justify-center overflow-hidden bg-primary pt-32 pb-16 text-primary-foreground">
        ...
        <div className="container-x relative z-10 text-center">
          ...
          >
            تصفح جزءاً من إنجازاتنا التي تعكس التزامنا بالجودة والاحترافية. صروح معمارية تم تنفيذها بأعلى المعايير الهندسية (حيث تعرض هذه الصور جزءاً من أعمالنا وليست المشاريع بأكملها).
          </motion.p>
        </div>
      </section>
